        ...
        <div className="footer-first column-one">
          ...
          <div className="footer-icons column-two">
            <div className="app-store column-two">
              <div>
                <img src="https://img.icons8.com/ios-filled/48/000000/apple-app-store--v1.png" />
                <h4>App Store</h4>
              </div>
              <div>
                <img src="https://img.icons8.com/ios/48/000000/google-play--v1.png" />
                <h4>Google Play</h4>
              </div>
            </div>
            <div className="social-media-icons column-one">
              ...
              <img src="https://img.icons8.com/metro/48/000000/instagram-new.png" />
